    ...
    <form action="#" method="post" enctype="multipart/form-data">
                ...
                if ($filesize < 20971520) {
                    if ($ext == 'jpg' || $ext == 'png' || $ext == 'jpeg') {
                        if (move_uploaded_file($tempname, $folder)) {
                            unlink($data1['image']);
                            $query = "UPDATE  tasks SET name, email, message,image,fname) VALUES('$name','$email','$message','$folder','$finalname')";
        ...
        ?>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control  mb-4" id="exampleFormControlTextarea1" name="message" value="<?= $data1['message']; ?>" rows="3"></textarea>
                </div>
                <div class="mb-3 d-flex flex-column">
